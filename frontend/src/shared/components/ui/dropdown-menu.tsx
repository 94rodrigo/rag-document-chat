...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'data-[state=open]:bg-elevated text-text-primary',
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && 'pl-8',
      '[&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-text-secondary',
      className,
    )}
    {...props}
  />
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      'transition-colors focus:bg-elevated text-text-primary',
      'disabled:pointer-events-none disabled:opacity-50',
      className,
    )}
    checked={checked}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1 text-[11px] font-medium text-text-tertiary uppercase tracking-wider',
      inset && 'pl-8',
      className,
    )}
    {...props}
