...
// Public shell (no auth required) for standalone content pages — legal, contact, etc.
export function SimpleLayout() {
  ...
  return (
    <div className="min-h-screen bg-base flex flex-col">
      ...
      <div className="px-6 py-4 text-center text-xs text-text-tertiary border-t border-border-subtle">
        {t('authLayout.rights', { year: new Date().getFullYear() })} ·{' '}
        <Link to="/privacy" className="hover:text-text-secondary transition-colors">{t('authLayout.privacy')}</Link>
        {' · '}
